...
export default class Main {
  ...
  async initWebGL() {
    return new Promise(async (resolve, reject)=> {
      ...
      // fireworksScene
      this.fireworksScene = new FireworksScene();
      await this.fireworksScene.init(this.renderer, this.camera);
      this.scene.add(this.fireworksScene.object);
  ...
  render() {
    ...
    // this.fireworksScene.update(time);
  }
